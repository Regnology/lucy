...
export class RequirementComponent implements OnInit {
  ...
  constructor(protected requirementService: RequirementService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.requirements = [];
  ...
  loadAll(): void {
    ...
    this.requirementService
      ...
      .subscribe({
        next: (res: HttpResponse<IRequirement[]>) => {
          this.isLoading = false;
          this.paginateRequirements(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateRequirements(data: IRequirement[] | null, headers: HttpHeaders): void {
